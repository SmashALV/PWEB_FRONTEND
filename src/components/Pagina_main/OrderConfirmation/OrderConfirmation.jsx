...
const OrderConfirmation = ({ cart, address }) => {
  console.log('OrderConfirmation - cart:', cart);
  console.log('OrderConfirmation - address:', address);
          ...
          <div className="OrderCartBox" id="resumen">
            {cart.map(item => (
              <div className="OrderCartItem" key={item.id}>
                ...
                <div className="OrderCartItem-price">S/ {(Number(item.price) || 0).toFixed(2)}</div>
